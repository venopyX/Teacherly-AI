...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${merriweather.variable} ${lato.variable} scroll-smooth`}>
      <body className="bg-background text-text-color font-body antialiased min-h-screen relative m-0 p-0 overflow-x-hidden">
